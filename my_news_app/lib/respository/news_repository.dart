...
class NewsRepository{
  ...
  Future<NewsChannelHeadlinesModel> fetchNewsChannelHeadlinesApi(String source)async{
    String url = 'https://newsapi.org/v2/top-headlines?sources=$source&apiKey=66a93a292ef2452ab0a7a4691c505a11';
  ...
  Future<CategoriesNewsModel> fetchNewsCategoriesApi(String category)async{
    String url = 'https://newsapi.org/v2/everything?q=$category&apiKey=66a93a292ef2452ab0a7a4691c505a11';
    final response = await http.get(Uri.parse(url));
